...
public class KNNBasedOnSoilElement {
    ...
    public List<String> givePrediction(String khotiyanNumber) throws Exception {
        ...
        List<CropElementPercentage> tempList = dao.getAll();
        ...
        GetBeans<KhotiyanElementPercentageDao> getBeans1 = new GetBeans<>();
        getBeans1.setFileName("dbBean.xml");
        KhotiyanElementPercentageDao dao1 = getBeans1.getBean("khotiyanElementPercentageDao");

        //Try-Catch put here for brats who search by non-existing khotiyan number
        try {
            Khotiyan_Element_Percentage tempCrop = dao1.getByKhotianNumberSoil(khotiyanNumber);
            ...
            for (int i = 0; i < k; i++) {
                ...
                predictionList.addAll(dao.getCropNameFromElements(tempModel));
